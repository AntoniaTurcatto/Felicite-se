            ...
            <div id="cadastro">
                <form method="post" action="cadastroEvento.php"> 
                  ...
                  <p> 
                    ...
                    <input id="dataEvento" name="dataEvento" required="required" type="date" placeholder="Data" />
                  </p>
        
                  <p> 
                    <label for="localEvento">Local do evento</label>
                    <input id="localEvento" name="localEvento" required="required" type="text" placeholder="Local" /> 
                  </p>
        
                   <p> 
                    <label for="responsavelEvento">Responsável do evento</label>
                    <input id="responsavelEvento" name="responsavelEvento" required="required" type="text" placeholder="Responsável" /> 
                  </p>
