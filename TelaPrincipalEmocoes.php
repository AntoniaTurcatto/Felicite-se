...
<head>
    ...
    <script>
        ...
        function editarEmocao(codEmocao) {
            // Crie uma URL com o código do livro para a página de edição
            var url = "editarArtigo.php?codEmocao=" + codEmocao;
...
<body>
    ...
    <div class="div-botao">
        <a href="CadastroEmocoes.html"><button class="cadastro-botao">Cadastrar</button></a>
    </div>
    <div class="table-container">
        <table class="tabela-scroll">
            <thead>
                <tr>
                    <th>Tipo de Emoção:</th>
                    <th>Data Emoção:</th>
            ...
            <tbody>
                ...
                if ($result->rowCount() > 0) {
                    while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
                        echo "<tr>
                        <td>" . $row["tipoEmocao"] . "</td>
                        <td>" . $row["dataEmocao"] . "</td>
                        
                        <td>
                            <button class='editar-botao' id='alterar' onclick='editarEmocao(" . $row["codEmocao"] . ")'></button>
